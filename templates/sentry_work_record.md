...
| Prompt template / revision / conformance | templates/sentry_issue_run_prompt.md / 0.4.7 / pending |
...
Provenance: plugin pending; framework revision pending; playbook sentry_issue_remediation 0.4.7.
```
