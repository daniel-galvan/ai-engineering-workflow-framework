...
- Evaluate the v0.3.3 prompt and controls with the existing model baseline on comparable real runs.
...
- Perform a cross-playbook failure audit after collecting comparable v0.3.3 run evidence.
